...
config.General.requestName = 'TTree_13TeV_SingleMuon2017F_JpsiZUps_NoTrigger_Compact1'
...
config.JobType.outputFiles = ['SingleMuonDatasetEtab17Nov_2017F_JpsiUpsilonZ_NoTriggered_Compact.root']
