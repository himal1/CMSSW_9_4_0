...
process.JetMatch = cms.EDProducer("PATTriggerMatcherDRLessByR",
    ...
    pathNames = cms.vstring('HLT_Jet30U_v*', 
        'HLT_Jet60_v*', 
        'HLT_Jet80_v*', 
        'HLT_Jet110_v*', 
        'HLT_Jet150_v*', 
...
process.cleanPatJetsTriggerMatch = cms.EDProducer("PATTriggerMatchJetEmbedder",
    matches = cms.VInputTag("JetMatch"),
    src = cms.InputTag("cleanPatJets")
)
...
process.patJets = cms.EDProducer("PATJetProducer",
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("secondaryVertexTagInfosAOD")),
...
process.patMETsTriggerMatch = cms.EDProducer("PATTriggerMatchMETEmbedder",
    matches = cms.VInputTag("somePatMetTriggerMatchHLTMET120"),
...
process.selectedPatElectronsTriggerMatch = cms.EDProducer("PATTriggerMatchElectronEmbedder",
    matches = cms.VInputTag("somePatElectronTriggerMatchHLTEle17CaloIdTCaloIsoVLTrkIdVLTrkIsoVL"),
    src = cms.InputTag("selectedPatElectrons")
)


process.selectedPatJetsTriggerMatch = cms.EDProducer("PATTriggerMatchJetEmbedder",
    matches = cms.VInputTag("somePatJetTriggerMatchHLTMu8DiJet30"),
    src = cms.InputTag("selectedPatJets")
)


process.selectedPatMuonsTriggerMatch = cms.EDProducer("PATTriggerMatchMuonEmbedder",
    matches = cms.VInputTag("somePatMuonTriggerMatchHLTMu8DiJet30"),
    src = cms.InputTag("selectedPatMuons")
)


process.selectedPatPhotonsTriggerMatch = cms.EDProducer("PATTriggerMatchPhotonEmbedder",
    matches = cms.VInputTag("somePatPhotonTriggerMatchHLTPhoton26Photon18"),
    src = cms.InputTag("selectedPatPhotons")
)


process.selectedPatTausTriggerMatch = cms.EDProducer("PATTriggerMatchTauEmbedder",
    matches = cms.VInputTag("somePatTauTriggerMatchHLTDoubleMediumIsoPFTau30Trk1eta2p1"),
    src = cms.InputTag("selectedPatTaus")
)


process.somePatElectronTriggerMatchHLTEle17CaloIdTCaloIsoVLTrkIdVLTrkIsoVL = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatElectronTriggerMatchL1EGammaCollection = cms.EDProducer("PATTriggerMatcherDRLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatJetTriggerMatchHLTPFJet40 = cms.EDProducer("PATTriggerMatcherDRLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatMetTriggerMatchHLTMET120 = cms.EDProducer("PATTriggerMatcherDRLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatMetTriggerMatchHLTMu17 = cms.EDProducer("PATTriggerMatcherDRLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatMuonTriggerMatchHLTDoubleMu5IsoMu5 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatMuonTriggerMatchHLTMu17 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    matched = cms.InputTag("patTrigger"),
    matchedCuts = cms.string('path( "HLT_Mu17_v*" )'),
    maxDPtRel = cms.double(0.5),
    maxDeltaR = cms.double(0.5),
...
process.somePatMuonTriggerMatchHLTMu8DiJet30 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatMuonTriggerMatchPDSingleMu = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatMuonTriggerMatchTriggerMuon = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatPhotonTriggerMatchHLTPhoton26Photon18 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.somePatTauTriggerMatchHLTDoubleMediumIsoPFTau30Trk1eta2p1 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    matched = cms.InputTag("patTrigger"),
...
process.PATEventTree = cms.EDAnalyzer("PATEventTree",
    ...
    rootFileName = cms.untracked.string('SingleMuonDatasetEtab17Nov_2017E_JpsiUpsilonZ_NoTriggered_Compact.root'),
...
process.out = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring('keep *', 
        ...
        'keep *_selectedPatJetsTriggerMatch_*_PAT', 
        'drop *_selectedPatTaus_*_*', 
        'keep *_selectedPatTausTriggerMatch_*_PAT', 
        'drop *_patMETs_*_*', 
        'keep *_patMETsTriggerMatch_*_PAT', 
        'drop *_selectedPatPhotons_*_*', 
        'keep *_selectedPatPhotonsTriggerMatch_*_PAT')
)
...
process.triggerMatcherExamplesTask = cms.Task(process.somePatElectronTriggerMatchHLTEle17CaloIdTCaloIsoVLTrkIdVLTrkIsoVL, process.somePatElectronTriggerMatchL1EGammaCollection, process.somePatJetTriggerMatchHLTMu8DiJet30, process.somePatJetTriggerMatchHLTPFJet40, process.somePatMetTriggerMatchHLTMET120, process.somePatMetTriggerMatchHLTMu17, process.somePatMuonTriggerMatchHLTDoubleMu5IsoMu5, process.somePatMuonTriggerMatchHLTMu17, process.somePatMuonTriggerMatchHLTMu8DiJet30, process.somePatMuonTriggerMatchPDSingleMu, process.somePatMuonTriggerMatchTriggerMuon, process.somePatPhotonTriggerMatchHLTPhoton26Photon18, process.somePatTauTriggerMatchHLTDoubleMediumIsoPFTau30Trk1eta2p1)
...
process.patAlgosToolsTask = cms.Task(process.cleanPatJetsTriggerMatch, process.patMETPF, process.patMETsTriggerMatch, process.patTrigger, process.selectedPatElectronsTriggerMatch, process.selectedPatJets, process.selectedPatJetsTriggerMatch, process.selectedPatMuonsTriggerMatch, process.selectedPatPhotonsTriggerMatch, process.selectedPatTausTriggerMatch, process.triggerMatcherExamplesTask)
...
process.goodHPSPFTaus = cms.Sequence(process.hpsPFTauChargedIsoPtSum+process.hpsPFTauNeutralIsoPtSum+process.hpsPFTauPUcorrPtSum+process.hpsPFTauNeutralIsoPtSumWeight+process.hpsPFTauFootprintCorrection+process.hpsPFTauPhotonPtSumOutsideSignalCone+process.hpsPFTauDiscriminationByRawCombinedIsolationDBSumPtCorr3Hits+process.hpsPFTauDiscriminationByLoosePileupWeightedIsolation3Hits+process.hpsPFTauDiscriminationByMediumPileupWeightedIsolation3Hits+process.hpsPFTauDiscriminationByTightPileupWeightedIsolation3Hits+process.hpsPFTauDiscriminationByPhotonPtSumOutsideSignalCone+process.hpsPFTauDiscriminationByRawPileupWeightedIsolation3Hits)
...
process.patDefaultSequence = cms.Sequence(process.patCandidateSummary+process.selectedPatCandidates+process.cleanPatCandidates+process.countPatCandidates+process.patTrigger, cms.Task(process.makePatMETsTask, process.makePatOOTPhotonsTask, process.muonPFIsolationPATTask, process.patElectrons, process.patJetCharge, process.patJetCorrectionsTask, process.patJets, process.patMuons, process.patPFCandidateIsoDepositSelectionTask, process.patPFTauIsolationTask, process.patPhotons, process.patTaus, process.pfElectronIsolationPATTask, process.pfParticleSelectionForIsoTask, process.pfPhotonIsolationPATTask))
...
process.p = cms.Path(process.patDefaultSequence+process.goodMuons+process.JPsiToMuMu+process.PATEventTree)
