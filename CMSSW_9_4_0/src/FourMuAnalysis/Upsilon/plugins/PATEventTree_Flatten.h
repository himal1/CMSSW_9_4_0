...
class PATEventTree : public edm::EDAnalyzer {
 ...
 private:
  ...
  // HLT filters passed
  bool  fHLTP_DoubleMu3_Filters[5], fHLTP_DoubleMu6_Filters[5], fHLTP_DoubleMu7_Filters[5], fHLTP_TripleMu5_Filters[5], fHLTP_Dimuon0_Jpsi_Filters[7], fHLTP_QuadMuon0_Dimuon0_Jpsi_Filters[7], fHLTP_QuadMuon0_Dimuon0_Upsilon_Filters[7], fHLTP_Dimuon0_Upsilon_Muon_Filters[7], fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[8], fHLTP_Dimuon10_Jpsi_Barrel_Filters[7],fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[11],  fHLTP_IsoMu24_Filters[7], fHLTP_IsoMu27_Filters[7], fHLTP_Mu50_Filters[6];
